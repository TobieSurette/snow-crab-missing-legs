...
legend("bottomright", legend = c("Cheliped", paste("Leg", 2:5)), lwd = 3, col = cols, bg = "white", cex = 1.25)
box()
...
# Image version:
windows(width = 11, height = 8.5)
image(60:140, years, t(I), col = colorRampPalette(c("white", "black"))(100), 
      breaks = c(seq(0, 0.50, len = 100), 1.1),
      xlab = "Carapace width (mm)", ylab = "Years", cex.lab = 1.25,
      xaxs = "i", yaxs = "i", xaxt = "n", yaxt = "n",
      xlim = c(59.5, 130.5), ylim = c(1989.5, 2017.5))
axis(2, at = seq(1990, 2018, by = 2))
axis(1, at = seq(40, 140, by = 5))
box()
lens <- 60:131
...
index <- (b$year > 2012) & (b$year <= 2017) & (b$maturity > 0.5) & (b$carapace.width >= 60)
